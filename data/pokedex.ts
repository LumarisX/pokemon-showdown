export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	regiterror: {
		...
		types: ["Ghost"],
		gender: "N",
		baseStats: {hp: 80, atk: 200, def: 50, spa: 100, spd: 50, spe: 100},
		abilities: {0: "Frisk", H: "Cursed Body"},
		heightm: 2.3,
		weightkg: 20,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	regiearth: {
		...
		types: ["Ground"],
		gender: "N",
		baseStats: {hp: 150, atk: 150, def: 80, spa: 75, spd: 50, spe: 75},
		abilities: {0: "Sand Force"},
		heightm: 1.3,
		weightkg: 2012,
		color: "Brown",
	...
	regisky: {
		...
		types: ["Flying"],
		gender: "N",
		baseStats: {hp: 80, atk: 50, def: 75, spa: 150, spd: 75, spe: 150},
